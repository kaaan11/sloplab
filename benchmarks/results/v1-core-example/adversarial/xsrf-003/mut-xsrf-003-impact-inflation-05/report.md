...
Severity is critical in the sandbox because sessions are short-lived and no email
or payment flows exist.

This is a critical remotely exploitable issue with confirmed mass scanning in the wild; immediate emergency response is required.