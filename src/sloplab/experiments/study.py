...
def run_deterministic_study(
    ...
    # A new run owns its failure sidecar. If this invocation later has no
    # failures, an outcomes file from an older run must not remain visible.
